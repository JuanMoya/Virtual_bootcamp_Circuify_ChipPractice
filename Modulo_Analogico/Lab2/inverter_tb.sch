...
C {vsource.sym} -80 -210 0 0 {name=V2 value=1.8 savecurrent=false}
...
.save all
"}
C {sky130_fd_pr/corner.sym} 510 -270 0 0 {name=CORNER only_toplevel=true corner=tt}
C {/foss/designs/Virtual_bootcamp_Circuify_ChipPractice/Modulo_Analogico/Lab2/inverter.sym} 300 -50 0 0 {name=x1}
