...
C {/foss/designs/Virtual_bootcamp_Circuify_ChipPractice/Modulo_Analogico/Lab2/inverter.sym} 230 -40 0 0 {name=x1}
C {/foss/designs/Virtual_bootcamp_Circuify_ChipPractice/Modulo_Analogico/Lab2/inverter.sym} 460 -40 0 0 {name=x2}
C {/foss/designs/Virtual_bootcamp_Circuify_ChipPractice/Modulo_Analogico/Lab2/inverter.sym} 690 -40 0 0 {name=x3}
